...
function getNumbers() {
    ...
    document.getElementById('msg').innerHTML = "Calculate the difference..."
    var num1 = Math.floor(Math.random() * (difficulty + 1));
    document.getElementById('num1').innerHTML = num1;
    document.getElementById('num2').innerHTML = Math.floor(Math.random() * (num1 + 1));
}
